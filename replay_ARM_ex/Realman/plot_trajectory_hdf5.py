...
def plot_rotations(qpos):
    ...
    quaternions = qpos[:, 3:7]  # Assuming the last four columns are quaternions (Q_X, Q_Y, Q_Z, Q_W)
...
# Load the data
dataset_path = '/home/onestar/FastUMI_replay_singleARM/base_unplug_charger/episode_0.hdf5'  # Change this to the actual path
